...
import { useForwardPropsEmits, PopoverRoot, PopoverAnchor, PopoverPortal, PopoverContent, PopoverTrigger } from "reka-ui";
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/ui/popover/PopoverAnchor.vue");
