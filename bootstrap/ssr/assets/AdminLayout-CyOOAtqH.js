import { defineComponent, unref, mergeProps, withCtx, renderSlot, useSSRContext, computed, createVNode, createTextVNode, resolveDynamicComponent, createBlock, openBlock, Fragment, toDisplayString, ref } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderVNode } from "vue/server-renderer";
import { usePage, Link } from "@inertiajs/vue3";
import { cva } from "class-variance-authority";
import { c as cn, _ as _sfc_main$F } from "./index-53Kg4F4g.js";
import { useForwardPropsEmits, DialogRoot, DialogClose, DialogOverlay, DialogPortal, DialogContent, DialogDescription, DialogTitle, DialogTrigger, createContext, Primitive, TooltipProvider } from "reka-ui";
import { reactiveOmit, useMediaQuery, useVModel, useEventListener } from "@vueuse/core";
import { X, PanelLeft, Shield, LayoutDashboard, Users, Tags, ArrowLeft } from "lucide-vue-next";
import { _ as _sfc_main$A } from "./Input-BNuRmWJk.js";
import { e as _sfc_main$B, f as _sfc_main$C, g as _sfc_main$D, h as _sfc_main$G } from "./UserDropdown-C5kfPJJO.js";
import { _ as _sfc_main$E } from "./Separator-C0fcDgz2.js";
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$w), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$t, { class: "sr-only" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_sfc_main$s, null, {
                          ...
                          _push4(ssrRenderComponent(_sfc_main$v, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!__props.tooltip) {
        _push(ssrRenderComponent(_sfc_main$d, mergeProps({ ...delegatedProps.value, ..._ctx.$attrs }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            } else {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$C), { "as-child": "" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$d, { ...delegatedProps.value, ..._ctx.$attrs }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    return [
                      createVNode(_sfc_main$d, { ...delegatedProps.value, ..._ctx.$attrs }, {
                        default: withCtx(() => [
                          renderSlot(_ctx.$slots, "default")
                        ]),
                        _: 3
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$j), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$c), { "as-child": "" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Link), {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(Shield), { class: "h-6 w-6" }, null, _parent5, _scopeId4));
                              _push5(`<span class="font-semibold"${_scopeId4}>Administration</span>`);
                            } else {
                              return [
                                createVNode(unref(Shield), { class: "h-6 w-6" }),
                                createVNode("span", { class: "font-semibold" }, "Administration")
                              ];
                            }
                          }),
                          _: 1
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$c), {
                                "as-child": "",
                                active: unref($page).url === _ctx.route("admin.dashboard")
                              }, {
                                  ...
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(Link), {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(unref(LayoutDashboard), { class: "h-4 w-4" }, null, _parent7, _scopeId6));
                                          _push7(`<span${_scopeId6}>Dashboard</span>`);
                                        } else {
                                          return [
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$b), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$c), {
                                "as-child": "",
                                active: unref($page).url.startsWith(_ctx.route("admin.users.index"))
                              }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(Link), {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(unref(Users), { class: "h-4 w-4" }, null, _parent7, _scopeId6));
                                          _push7(`<span${_scopeId6}>Users</span>`);
                                        } else {
                                          return [
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$b), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$c), {
                                "as-child": "",
                                active: unref($page).url.startsWith(_ctx.route("admin.categories.index"))
                              }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(Link), {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(unref(Tags), { class: "h-4 w-4" }, null, _parent7, _scopeId6));
                                          _push7(`<span${_scopeId6}>Categories</span>`);
                                        } else {
                                          return [
                                            createVNode(unref(Tags), { class: "h-4 w-4" }),
                                            createVNode("span", null, "Categories")
                                          ];
                                        }
                                      }),
                                      _: 1
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$b), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$c), { "as-child": "" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(Link), {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(unref(ArrowLeft), { class: "h-4 w-4" }, null, _parent7, _scopeId6));
                                          _push7(`<span${_scopeId6}>Back to App</span>`);
                                        } else {
                                          return [
                                            createVNode(unref(ArrowLeft), { class: "h-4 w-4" }),
                                            createVNode("span", null, "Back to App")
                                          ];
                                        }
                                      }),
                                      _: 1
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(_sfc_main$5), _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex min-h-screen w-full"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`<div class="flex-1 flex flex-col"${_scopeId}><nav class="bg-white border-b border-gray-100 px-4 py-3"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="flex items-center gap-4"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), { class: "md:hidden" }, null, _parent2, _scopeId));
            _push2(`<h1 class="text-lg font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(pageTitle.value)}</h1></div>`);
            _push2(ssrRenderComponent(_sfc_main$G, null, null, _parent2, _scopeId));
            _push2(`</div></nav><main class="flex-1 bg-gray-50 p-6"${_scopeId}><div class="max-w-7xl mx-auto"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div></main></div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex min-h-screen w-full" }, [
                createVNode(_sfc_main$1),
                createVNode("div", { class: "flex-1 flex flex-col" }, [
                  createVNode("nav", { class: "bg-white border-b border-gray-100 px-4 py-3" }, [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", { class: "flex items-center gap-4" }, [
                        createVNode(unref(_sfc_main$2), { class: "md:hidden" }),
                        createVNode("h1", { class: "text-lg font-semibold text-gray-900" }, toDisplayString(pageTitle.value), 1)
                      ]),
                      createVNode(_sfc_main$G)
                    ])
                  ]),
                  createVNode("main", { class: "flex-1 bg-gray-50 p-6" }, [
