import { ref, watch, withCtx, unref, createTextVNode, createVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      description: props.depot.description,
      ...
      country: props.depot.country || "FR"
    });
    watch(location, (value) => {
      ...
      if (value) {
        ...
        form.address = addressParts.join(" ") || value.name;
    ...
    const updateDepot = () => {
      form.put(route("app.organizations.depots.update", props.depot.id), {
        onSuccess: () => {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    ...
                    description: "Modifiez les informations de ce lieu de stockage."
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$4), { for: "location" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Modifier l&#39;adresse`);
                      } else {
                        return [
                          createTextVNode("Modifier l'adresse")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(`</div></div><div class="flex justify-end gap-4 pt-4 border-t"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("section", { class: "space-y-6" }, [
                      ...
                      createVNode("div", { class: "max-w-2xl" }, [
                        createVNode("form", {
                          onSubmit: withModifiers(updateDepot, ["prevent"]),
                          class: "space-y-8"
                        }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/App/Organizations/Settings/Depots/Edit.vue");
