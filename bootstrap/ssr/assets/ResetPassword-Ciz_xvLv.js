    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Réinitialiser le mot de passe" }, null, _parent2, _scopeId));
            ...
            return [
              createVNode(unref(Head), { title: "Réinitialiser le mot de passe" }),
              createVNode("form", {
