...
import { _ as _sfc_main$4 } from "./HeadingSmall-B1yfmTIh.js";
import { _ as _sfc_main$2 } from "./AppLayout-B3jJCr1A.js";
import { _ as _sfc_main$3 } from "./Layout-C4o8p68d.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({ breadcrumbs: breadcrumbItems }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Paramètres d'apparence" }, null, _parent2, _scopeId));
            ...
            return [
              createVNode(unref(Head), { title: "Paramètres d'apparence" }),
