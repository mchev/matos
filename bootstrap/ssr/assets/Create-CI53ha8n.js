    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Create Category</h1><p class="text-muted-foreground"${_scopeId}> Add a new equipment category </p></div>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Fill in the details to create a new category `);
                            } else {
                              return [
                                createTextVNode(" Fill in the details to create a new category ")
                              ];
                            }
                          }),
                          _: 1
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$d), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$e), { value: "" }, {
                                    ...
                                    return [
                                      createVNode(unref(_sfc_main$e), { value: "" }, {
                                        default: withCtx(() => [
                                          createTextVNode("No parent (Top level)")
                                        ]),
                                        _: 1
              ...
              createVNode("div", { class: "space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Create Category"),
                    createVNode("p", { class: "text-muted-foreground" }, " Add a new equipment category ")
                  ]),
                  createVNode(unref(_sfc_main$2), {
                    variant: "outline",
                    "as-child": ""
